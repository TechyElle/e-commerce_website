...
const emptyProduct = {
  name: '',
  price: 0,
  image: '/src/imports/Products/Products/Arduino Uno.png',
  category: 'Components',
  description: '',
  rating: 4.8,
  reviews: 0,
          ...
          <TabsContent value="products" className="mt-6 grid grid-cols-1 xl:grid-cols-3 gap-6">
            <DataPanel title={editingId ? 'Edit Product' : 'Add Product'}>
              <div className="space-y-3">
                ...
                <AdminInput label="Image Path" value={draft.image} onChange={(value) => setDraft({ ...draft, image: value })} />
                ...
                <button onClick={saveProduct} className="w-full cyber-button py-3">
            ...
            <DataPanel title="Product Management" className="xl:col-span-2">
              <ResponsiveTable headers={['Product', 'Category', 'Price', 'Stock', 'Actions']}>
