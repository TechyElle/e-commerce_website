    ...
    <div className="min-h-screen bg-[#111111] py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <div
            className="inline-block mt-3 px-4 py-2 border border-[rgba(0,191,223,0.3)] bg-[rgba(0,191,223,0.08)]"
          >
            <span
              className="text-[#00BFDF] text-sm"
              style={{ fontFamily: 'Orbitron, sans-serif', fontWeight: 700 }}
            >
              Order #{order.id}
            </span>
        ...
        {/* Order Details Card */}
        <div className="bg-[#1e1e1e] border border-[rgba(255,255,255,0.1)] p-6 mb-6">

          {/* Order Items */}
          <div className="flex items-center gap-2 mb-4">
            <Package className="w-5 h-5 text-[#00BFDF]" />
            <h2
          ...
          <div className="space-y-3 mb-6">
            {order.items.map((item) => (
              ...
              >
                <div className="w-12 h-12 bg-[#111111] flex-shrink-0 overflow-hidden">
                  <img
                    src={item.image}
                    alt={item.name}
                ...
                <span
                  className="text-[#ff6b35] text-sm flex-shrink-0"
                  style={{ fontFamily: 'Orbitron, sans-serif', fontWeight: 700 }}
                >
          ...
          {/* Payment Info */}
          <div className="flex items-center gap-2 mb-4">
            <CreditCard className="w-5 h-5 text-[#00BFDF]" />
            <h2
              className="text-lg text-white"
              style={{ fontFamily: 'Orbitron, sans-serif', fontWeight: 700 }}
            >
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span
                className={order.shipping === 0 ? 'text-[#10b981]' : 'text-white'}
                style={{ fontFamily: 'Rajdhani, sans-serif', fontWeight: 600 }}
              >
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Link to="/products" className="flex-1" onClick={clearCart}>
            <button
              className="w-full py-3 border border-[#00BFDF] text-[#00BFDF] hover:bg-[#00BFDF] hover:text-black transition-all"
